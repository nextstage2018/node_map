...
import { FolderOpen, Plus, Clock, FileText, Phone, Mail, MessageSquare, Handshake, X, ChevronRight } from 'lucide-react';
    ...
    <div className="flex flex-col h-screen bg-white">
      ...
      <div className="flex-1 overflow-hidden flex">
        {/* ========================================
            左サイドバー: プロジェクト一覧
            ======================================== */}
        <aside className="w-60 border-r border-slate-200 bg-slate-50 flex flex-col shrink-0">
        ...
        {/* ========================================
            中央: タイムライン
            ======================================== */}
        <main className={`flex-1 overflow-y-auto ${selectedEvent ? 'border-r border-slate-200' : ''}`}>
          {/* タイムラインヘッダー */}
          ...
          {/* 新規イベントフォーム */}
          {showNewEvent && (
            <div className="mx-6 mt-4 p-4 bg-slate-50 border border-slate-200 rounded-lg">
        ...
        {/* ========================================
            ...
            ======================================== */}
        {selectedEvent && (
          <aside className="w-80 bg-slate-50 overflow-y-auto shrink-0">
            <div className="p-5">
