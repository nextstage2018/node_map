...
import { Inbox, CheckSquare, Map, Users, BookOpen, Settings, ClipboardList, Bot, Building2, Sprout, GitBranch } from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { href: '/thought-map', label: '思考動線', icon: GitBranch },
